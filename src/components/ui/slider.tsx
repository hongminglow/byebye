        ...
        >
          ...
          {Array.from({ length: _values.length }, (_, index) => (
            <BaseSlider.Thumb
              ...
              key={index}
              className="border-primary bg-background ring-ring/50 block size-4 shrink-0 rounded-full border shadow-sm transition-[color,box-shadow] hover:ring-4 focus-visible:ring-4 focus-visible:outline-hidden relative"
            >
              <span
                className="absolute left-1/2 -translate-x-1/2 top-3 text-xs rounded px-2 py-1  text-gray-600"
